...
[#135 Analyseren van Sequence 01 van de KITTI dataset](https://github.com/urbinn/urbinn/issues/135) | De sequence 01 van de Kitti dataset had geen goede resultaten wanneer deze door ons Urb-systeem bewerkt werden. Door het analyseren van het probleem per frame ben ik erachter gekomen dat vele frames niet gekoppeld konden worden aan voorgaande frames vanwege een rotatie. Aan de hand van een rotatie check zijn deze problemen verholpen. | 
