...
Issue [83](#83), [86](#86) en [88](#88) zijn de issues die in mijn ogen erg nuttige issues waren. Aangezien deze issues bijdragen aan de creatie van onze eigen dataset waarbij onze dataset wellicht ook andere projecten kan ondersteunen. Door gebruik te maken van bestaand materiaal en het genereren van eigen materiaal hebben wij een grote en uitgebreide dataset gecreëerd. Daarnaast heb ik gewerkt aan een script die het mogelijk maakt om afbeeldingen inclusief de labels te spiegelen waardoor feitelijk de dataset verdubbeld kan worden. Ook de code waarmee het mogelijk is om het afgelegde traject middels een bovenaanzicht in kaart te brengen heb ik aangewerkt en ben erg blijk met dit resultaat. Tot slot heb ik in het onderstaande overzicht een korte beschrijving gemaakt per issue waaraan ik heb gewerkt:
...
[#98 YOLO config file beschrijven](https://github.com/urbinn/urbinn/issues/98) | | [Yolo Config file beschrijving](https://github.com/M4dmuffin/KB74-Urbinn-Portfolio/blob/master/Data/Issues/Issue%2098%20-%20YOLO%20config%20file%20beschrijven/Issue%2098%20-%20YOLO%20config%20file%20beschrijven%20%20-%20Blad1.pdf)
