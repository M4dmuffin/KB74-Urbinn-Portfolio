...
#19 Serie foto's als test case | Ik heb een camera meegenomen met een viertal Rubiks Kubussen om een aantal foto’s te nemen die we als eerste testcase kunnen gebruiken SLAM-algoritme uitproberen. | data
